# -*- coding: utf-8 -*-
#
# griffin documentation build configuration file, created by
...
copyright = u'2015{0}, Lynn Root, Spotify AB'.format(
...
release = find_version("../griffin/__init__.py")
...
latex_documents = [
  ('index', 'griffin.tex', u'griffin Documentation',
   u'Lynn Root', 'manual'),
]
...
man_pages = [
    ('index', 'griffin', u'griffin Documentation',
     [u'Lynn Root'], 1)
]
...
texinfo_documents = [
  ('index', 'griffin', u'griffin Documentation',
   u'Lynn Root', 'griffin', 'One line description of project.',
   'Miscellaneous'),
]
